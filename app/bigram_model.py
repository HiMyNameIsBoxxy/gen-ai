...
class BigramModel:
    def __init__(self, corpus, frequency_threshold=5):
        ...
        self.vocab = set()
        self.bigram_probs = self.analyze_bigrams(self.corpus)
    ...
    def analyze_bigrams(self, text):
        ...
        words = self.simple_tokenizer(text, self.frequency_threshold)
    ...
    def generate_text(self, bigram_probs, start_word, num_words=20):
...
# run the function in the right order is the next thing we need to do